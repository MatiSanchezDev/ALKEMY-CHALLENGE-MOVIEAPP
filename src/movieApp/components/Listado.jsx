...
export const Listado = ({ addOrRemoveFavs }) => {
  const { movieList } = useFetch();
    ...
    <div className="grid mt-4 mb-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 lg:gap-3 justify-items-center md:justify-around	">
      {movieList.map((movie) => (
        ...
        >
          ...
          <div className="absolute flex items-center justify-center w-9 h-4 top-2 left-2 bg-green-400 saturate-200 rounded-full text-xs font-bold text-[#243351]">
